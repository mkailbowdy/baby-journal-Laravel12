!(function () {
                ...
                C = {
                    ...
                    polygonEnd: function () {
                        ...
                        var t = l([n, r]),
                            ...
                            i = v.length;
                        (e || i) &&
                            (a.polygonStart(), e && (a.lineStart(), c(null, null, 1, a), a.lineEnd()), i && Lt(v, u, t, c, a), a.polygonEnd()),
                            (v = d = y = null);
                    },
                };
            return C;
    ...
    function Au(n, t) {
        ...
        var e = n.length != t.length,
            ...
            l = 1;
        if (
            (e && ((r += 'Q' + (u[0] - (2 * o[0]) / 3) + ',' + (u[1] - (2 * o[1]) / 3) + ',' + u[0] + ',' + u[1]), (i = n[1]), (l = 2)), t.length > 1)
        ) {
            (a = t[1]),
                (u = n[l]),
                l++,
    ...
    function Ou(n) {
        ...
        return (
            ...
            (t.interpolate = function (n) {
                return arguments.length
                    ? ((l = 'function' == typeof n ? (a = n) : (a = Tl.get(n) || xu).key), (c = a.reverse || a), (f = a.closed ? 'M' : 'L'), t)
                    : l;
            }),
            (t.tension = function (n) {
                ...
                (e.parseRows = function (n, t) {
                    function e() {
                        ...
                        if (34 === n.charCodeAt(t)) {
                            ...
                            return (
                                13 === r ? ((i = !0), 10 === n.charCodeAt(e + 2) && ++f) : 10 === r && (i = !0), n.slice(t + 1, e).replace(/""/g, '"')
                            );
                        }
                        for (; c > f; ) {
            ...
            return (
                (n.invert = function (n) {
                    var t = u.scale(),
                        ...
                        i = (n[1] - e[1]) / t;
                    return (
                        i >= 0.12 && 0.234 > i && r >= -0.425 && -0.214 > r ? o : i >= 0.166 && 0.234 > i && r >= -0.214 && -0.115 > r ? a : u
                    ).invert(n);
                }),
                (n.stream = function (n) {
                    var t = u.stream(n),
    ...
    (ao.geo.path = function () {
        function n(n) {
            return (
                n && ('function' == typeof a && u.pointRadius(+a.apply(this, arguments)), (o && o.valid) || (o = i(u)), ao.geo.stream(n, o)),
                u.result()
            );
        }
        function t() {
                  ...
                  (t.triangles = function (n) {
                      ...
                      return (
                          ar(e(n)).cells.forEach(function (e, r) {
                              for (
                                  var i, u, o = e.site, a = e.edges.sort(Ve), l = -1, c = a.length, f = a[c - 1].edge, s = f.l === o ? f.r : f.l;
                                  ++l < c;
    ...
    (Co.transition = function (n) {
        for (
            var t, e, r = Hl || ++Zl, i = Ku(n), u = [], o = Ol || { time: Date.now(), ease: Nr, delay: 0, duration: 250 }, a = -1, l = this.length;
            ++a < l;
        ...
        (Yl.transition = function () {
            for (var n, t, e, r, i = this.id, u = ++Zl, o = this.namespace, a = [], l = 0, c = this.length; c > l; l++) {
                ...
                for (var t = this[l], f = 0, s = t.length; s > f; f++)
                    (e = t[f]) && ((r = e[o][i]), Qu(e, f, o, u, { time: r.time, ease: r.ease, delay: r.delay + r.duration, duration: r.duration })),
                        n.push(e);
            }
            return Wu(a, o, u);
        }),
        ...
        function u() {
            ...
            function d() {
                ...
                x && ((n[0] += x[0]), (n[1] += x[1])),
                    C ||
                        (ao.event.altKey
                            ? (M || (M = [(s[0] + s[1]) / 2, (h[0] + h[1]) / 2]), (L[0] = s[+(n[0] < M[0])]), (L[1] = h[+(n[1] < M[1])]))
                            : (M = null)),
                    E && y(n, c, 0) && (r(k), (t = !0)),
                    A && y(n, f, 1) && (i(k), (t = !0)),
