            ...
            return (
                ...
                (b.margin = function (a) {
                    return arguments.length
                        ? ((f.top = 'undefined' != typeof a.top ? a.top : f.top), (f.left = 'undefined' != typeof a.left ? a.left : f.left), b)
                        : f;
                }),
                (b.width = function (a) {
                ...
                return (
                    x.each(function (b) {
                        ...
                        l.domain(d || d3.extent(b[0].values.map(n).concat(t))),
                            l.range(
                                v
                                    ? f || [(0.5 * x) / b[0].values.length, (x * (b[0].values.length - 0.5)) / b[0].values.length]
                                    : f || [5 + A / 2, x - A / 2 - 5],
                            ),
                            m.domain(e || [d3.min(b[0].values.map(s).concat(u)), d3.max(b[0].values.map(r).concat(u))]).range(g || [y, 0]),
                            l.domain()[0] === l.domain()[1] &&
                                l.domain(l.domain()[0] ? [l.domain()[0] - 0.01 * l.domain()[0], l.domain()[1] + 0.01 * l.domain()[1]] : [-1, 1]),
                            m.domain()[0] === m.domain()[1] &&
                                m.domain(m.domain()[0] ? [m.domain()[0] + 0.01 * m.domain()[0], m.domain()[1] - 0.01 * m.domain()[1]] : [-1, 1]);
                    ...
                    h.each(function (h) {
                        ...
                        if (
                            ...
                            f
                                ...
                                x
                                    .select('.nv-x.nv-axis')
                                    .attr('transform', 'translate(0,' + (d.range()[0] + (e.showValues() && d.domain()[0] < 0 ? 16 : 0)) + ')'),
            ...
            function b(p) {
                ...
                return (
                    p.each(function (b) {
                        ...
                        if ('classic' == o)
                            x.append('circle').style('stroke-width', 2).attr('class', 'nv-legend-symbol').attr('r', 5), (v = w.select('circle'));
                        else if ('furious' == o) {
            ...
            function b(p) {
                ...
                return (
                    p.each(function (b) {
                        ...
                        if ('classic' == o)
                            z.append('circle').style('stroke-width', 2).attr('class', 'nv-legend-symbol').attr('r', 5), (w = y.select('circle'));
                        else if ('furious' == o) {
                    ...
                    E.each(function (b) {
                        ...
                        m
                            ...
                            n.domain()[0] === n.domain()[1] &&
                                n.domain(n.domain()[0] ? [n.domain()[0] + 0.01 * n.domain()[0], n.domain()[1] - 0.01 * n.domain()[1]] : [-1, 1]),
                            (h = h || m),
                            (i = i || n);
                ...
                return (
                    y.each(function (b) {
                        ...
                        l.domain(c || d3.extent(b[0].values.map(n).concat(t))),
                            l.range(
                                v
                                    ? e || [(0.5 * y) / b[0].values.length, (y * (b[0].values.length - 0.5)) / b[0].values.length]
                                    : e || [5 + B / 2, y - B / 2 - 5],
                            ),
                ...
                return (
                    ...
                    N.each(function (b) {
                        ...
                        m.domain(
                            ...
                            m.range(
                                y && b[0] ? G || [(R * z + R) / (2 * b[0].values.length), R - (R * (1 + z)) / (2 * b[0].values.length)] : G || [0, R],
                            ),
                            n
                                .domain(
                                    F ||
                ...
                return (
                    ...
                    m.each(function (m) {
                        ...
                        G.enter()
                            ...
                            .on('mouseover', function (a) {
                                d3.select(this).classed('hover', !0),
                                    t.areaMouseover({ point: a, series: a.key, pos: [d3.event.pageX, d3.event.pageY], seriesIndex: a.seriesIndex });
                            })
                            .on('mouseout', function (a) {
                                d3.select(this).classed('hover', !1),
                                    t.areaMouseout({ point: a, series: a.key, pos: [d3.event.pageX, d3.event.pageY], seriesIndex: a.seriesIndex });
                            })
                            .on('click', function (a) {
                                d3.select(this).classed('hover', !1),
                                    t.areaClick({ point: a, series: a.key, pos: [d3.event.pageX, d3.event.pageY], seriesIndex: a.seriesIndex });
                            }),
                            G.exit().remove(),
                        ...
                        if (p) {
                            ...
                            (z = (A.length / 3) * 260),
                                ...
                                l.top != Math.max(i.height(), h.height()) &&
                                    ((l.top = Math.max(i.height(), h.height())), (L = a.utils.availableHeight(n, x, l))),
