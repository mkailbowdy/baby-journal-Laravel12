...
function ht(e, t, n) {
    ...
    var r = e.getBoundingClientRect(),
        i = 1,
        o = 1;
    t && _e(e) && ((i = (e.offsetWidth > 0 && pt(r.width) / e.offsetWidth) || 1), (o = (e.offsetHeight > 0 && pt(r.height) / e.offsetHeight) || 1));
...
var Sa = function (t, n) {
    return (t = typeof t == 'function' ? t(Object.assign({}, n.rects, { placement: n.placement })) : t), Si(typeof t != 'number' ? t : Ti(t, Bt));
};
function Ta(e) {
    var t,
        n = e.state,
...
function Ma(e) {
    ...
    i != null && ((typeof i == 'string' && ((i = t.elements.popper.querySelector(i)), !i)) || (Oi(t.elements.popper, i) && (t.elements.arrow = i)));
}
...
function Br(e) {
    ...
    if (f) {
        var m = $t(n),
            ...
            K = 'clientWidth';
        if (
            (m === fe(n) && ((m = We(n)), De(m).position !== 'static' && s === 'absolute' && ((L = 'scrollHeight'), (K = 'scrollWidth'))),
            (m = m),
            i === ce || ((i === ue || i === ye) && o === Dt))
        ) {
            u = be;
    ...
    if (((_ = z.x), (S = z.y), c)) {
        ...
        return Object.assign(
            ...
            (k[u] = O ? '0' : ''),
            (k[M] = E ? '0' : ''),
            (k.transform = (I.devicePixelRatio || 1) <= 1 ? 'translate(' + _ + 'px, ' + S + 'px)' : 'translate3d(' + _ + 'px, ' + S + 'px, 0)'),
            k),
        );
    }
...
function Da(e) {
    ...
    t.modifiersData.popperOffsets != null &&
        (t.styles.popper = Object.assign(
            {},
            t.styles.popper,
            Br(Object.assign({}, f, { offsets: t.modifiersData.popperOffsets, position: t.options.strategy, adaptive: a, roundOffsets: c })),
        )),
        t.modifiersData.arrow != null &&
            (t.styles.arrow = Object.assign(
                {},
                t.styles.arrow,
                Br(Object.assign({}, f, { offsets: t.modifiersData.arrow, position: 'absolute', adaptive: !1, roundOffsets: c })),
            )),
...
function ja(e) {
    var t,
        ...
        s = -r.scrollLeft + sr(e),
        c = -r.scrollTop;
    return De(i || n).direction === 'rtl' && (s += Ze(n.clientWidth, i ? i.clientWidth : 0) - o), { width: o, height: a, x: s, y: c };
}
function cr(e) {
    var t = De(e),
        n = t.overflow,
        ...
        for (
            var i = n.mainAxis,
                ...
                u = [h].concat(M).reduce(function (se, G) {
                    return se.concat(
                        Te(G) === nr
                            ? Wa(t, { placement: G, boundary: l, rootBoundary: v, padding: f, flipVariations: A, allowedAutoPlacements: S })
                            : G,
                    );
                }, []),
                I = t.rects.reference,
...
function qa(e) {
    var t = e.state,
        ...
        l = Fr(c),
        v = Fr(f);
    (t.modifiersData[n] = { referenceClippingOffsets: c, popperEscapeOffsets: f, isReferenceHidden: l, hasPopperEscaped: v }),
        (t.attributes.popper = Object.assign({}, t.attributes.popper, { 'data-popper-reference-hidden': l, 'data-popper-escaped': v }));
}
...
function Ya(e) {
    var t = e.state,
        ...
        c = s.x,
        f = s.y;
    t.modifiersData.popperOffsets != null && ((t.modifiersData.popperOffsets.x += c), (t.modifiersData.popperOffsets.y += f)),
        (t.modifiersData[r] = a);
}
...
function as(e, t, n) {
    ...
    return (
        (r || (!r && !n)) &&
            ((Me(t) !== 'body' || cr(o)) && (s = is(t)), _e(t) ? ((c = ht(t, !0)), (c.x += t.clientLeft), (c.y += t.clientTop)) : o && (c.x = sr(o))),
...
function ls(e) {
    var t = e.reduce(function (n, r) {
        ...
        return (
            (n[r.name] = i
                ? Object.assign({}, i, r, { options: Object.assign({}, i.options, r.options), data: Object.assign({}, i.data, r.data) })
                : r),
            n
        );
    }, {});
            ...
            _ = {
                ...
                setOptions: function (E) {
                    ...
                    S(),
                        ...
                        (l.scrollParents = { reference: it(s) ? Mt(s) : s.contextElement ? Mt(s.contextElement) : [], popper: Mt(c) });
...
var Ms = typeof window < 'u' && typeof document < 'u',
    ...
    Is = { allowHTML: !1, animation: 'fade', arrow: !0, content: '', inertia: !1, maxWidth: 350, role: 'tooltip', theme: '', zIndex: 9999 },
    xe = Object.assign(
        {
            appendTo: Ni,
...
function Bi(e) {
    ...
    var r = Ct();
    (r.className = Ri), r.setAttribute('data-state', 'hidden'), Zr(r, e.props), t.appendChild(n), n.appendChild(r), i(e.props, e.props);
    function i(o, a) {
        var s = $n(t),
            c = s.box,
            f = s.content,
        ...
        a.theme ? c.setAttribute('data-theme', a.theme) : c.removeAttribute('data-theme'),
            typeof a.animation == 'string' ? c.setAttribute('data-animation', a.animation) : c.removeAttribute('data-animation'),
...
function Bs(e, t) {
    ...
    function te(d) {
        return (u.state.isMounted && !u.state.isVisible) || Se.isTouch || (l && l.type === 'focus') ? 0 : An(u.props.delay, d ? 0 : 1, xe.delay);
    }
    function p(d) {
        d === void 0 && (d = !1), (m.style.pointerEvents = u.props.interactive && !d ? '' : 'none'), (m.style.zIndex = '' + u.props.zIndex);
    }
    function y(d, w, R) {
        if (
            (R === void 0 && (R = !0),
    ...
    function ze(d) {
        ...
        if (!(!u.state.isEnabled || qe(d) || s)) {
            ...
            (l = d),
                ...
                d.type === 'click' && (u.props.trigger.indexOf('mouseenter') < 0 || a) && u.props.hideOnClick !== !1 && u.state.isVisible
                    ? (R = !0)
                    : $(d),
                d.type === 'click' && (a = !R),
                R && !F && he(d);
    ...
    function D() {
        ...
        if (!(d || w || R || F) && !k().hasAttribute('disabled') && (y('onShow', [u], !1), u.props.onShow(u) !== !1)) {
            if (
                ((u.state.isVisible = !0), z() && (m.style.visibility = 'visible'), p(), G(), u.state.isMounted || (m.style.transition = 'none'), z())
            ) {
                var oe = Y(),
                    ge = oe.box,
                    ct = oe.content;
    ...
    function j() {
        ...
        if (!(d || w || R) && (y('onHide', [u], !1), u.props.onHide(u) !== !1)) {
            if (
                ((u.state.isVisible = !1), (u.state.isShown = !1), (f = !1), (a = !1), z() && (m.style.visibility = 'hidden'), W(), Z(), p(!0), z())
            ) {
                var B = Y(),
                    oe = B.box,
                    ge = B.content;
    ...
    function En() {
        u.state.isDestroyed || (u.clearDelayTimeouts(), u.unmount(), st(), delete e._tippy, (u.state.isDestroyed = !0), y('onDestroy', [u]));
    }
}
function jt(e, t) {
    t === void 0 && (t = {});
...
Object.assign({}, Ei, {
    effect: function (t) {
        var n = t.state,
            r = { popper: { position: n.options.strategy, left: '0', top: '0', margin: '0' }, arrow: { position: 'absolute' }, reference: {} };
...
function gr(e) {
    ...
    for (let o = 0; o < e.length; o++)
        if (
            ...
            (e[o].type === 'childList' &&
                (e[o].addedNodes.forEach((a) => a.nodeType === 1 && t.add(a)), e[o].removedNodes.forEach((a) => a.nodeType === 1 && n.add(a))),
            e[o].type === 'attributes')
        ) {
            let a = e[o].target,
                s = e[o].attributeName,
    ...
    for (let o of t)
        n.has(o) ||
            (o.isConnected && (delete o._x_ignoreSelf, delete o._x_ignore, Wi.forEach((a) => a(o)), (o._x_ignore = !0), (o._x_ignoreSelf = !0)));
    t.forEach((o) => {
...
function ro(e) {
    let t = [],
        n = (s) => t.push(s),
        [r, i] = Ks(e);
    return t.push(i), [{ Alpine: Wt, effect: r, cleanup: n, evaluateLater: ae.bind(ae, e), evaluate: et.bind(et, e) }, () => t.forEach((s) => s())];
}
function sc(e, t) {
    let n = () => {},
        r = cn[t.type] || n,
    ...
    zi(e, t.original, o);
    let a = () => {
        e._x_ignore || e._x_ignoreSelf || (r.inline && r.inline(e, t, i), (r = r.bind(r, e, t, i)), zn ? St.get(no).push(r) : r());
    };
...
function cc(e, t) {
    return ({ name: n, value: r }) => {
        let i = n.match(uo()),
            ...
            a = n.match(/\.[^.\]]+(?=[^\]]*$)/g) || [],
            s = t || e[n] || n;
        return { type: i ? i[1] : null, value: o ? o[1] : null, modifiers: a.map((c) => c.replace('.', '')), expression: r, original: s };
    };
}
var Vn = 'DEFAULT',
    Je = ['ignore', 'ref', 'data', 'id', 'anchor', 'bind', 'init', 'for', 'model', 'modelable', 'transition', 'show', 'if', Vn, 'teleport'];
function uc(e, t) {
...
var ei = !1;
function lc() {
    ei && ve('Alpine has already been initialized on this page. Calling Alpine.start() more than once can cause problems.'),
        (ei = !0),
        document.body ||
            ve("Unable to initialize. Trying to load Alpine before `<body>` is available. Did you forget to add `defer` in Alpine's `<script>` tag?"),
...
function Er(e, t) {
    return Array.isArray(t) ? ti(e, t.join(' ')) : typeof t == 'object' && t !== null ? gc(e, t) : typeof t == 'function' ? Er(e, t()) : ti(e, t);
}
function ti(e, t) {
    let n = (i) =>
            i
    ...
    (e._x_hidePromise = e._x_transition
        ...
        queueMicrotask(() => {
            ...
            a
                ...
                : i(() => {
                      let s = (c) => {
                          let f = Promise.all([c._x_hidePromise, ...(c._x_hideChildren || []).map(s)]).then(([l]) => l());
...
function Yn(e, t, { during: n, start: r, end: i } = {}, o = () => {}, a = () => {}) {
    if (
        (e._x_transitioning && e._x_transitioning.cancel(), Object.keys(n).length === 0 && Object.keys(r).length === 0 && Object.keys(i).length === 0)
    ) {
        o(), a();
        return;
    }
...
function xc(e, t) {
    let n,
        ...
        o = Xn(() => {
            ee(() => {
                (n = !0), r || t.before(), i || (t.end(), Gn()), t.after(), e.isConnected && t.cleanup(), delete e._x_transitioning;
            });
        });
    (e._x_transitioning = {
        beforeCancels: [],
...
function Eo(e, t, n, r = []) {
    switch ((e._x_bindings || (e._x_bindings = yt({})), (e._x_bindings[t] = n), (t = r.includes('camel') ? Nc(t) : t), t)) {
        case 'value':
            Sc(e, n);
            break;
        case 'style':
...
function Sc(e, t) {
    if (e.type === 'radio')
        e.attributes.value === void 0 && (e.value = t),
            window.fromModel && (typeof t == 'boolean' ? (e.checked = nn(e.value) === t) : (e.checked = ni(e.value, t)));
...
function $c(e, t) {
    ...
    (Ye[e] = t), typeof t == 'object' && t !== null && t.hasOwnProperty('init') && typeof t.init == 'function' && Ye[e].init(), Xi(Ye[e]);
}
function jc() {
    return Ye;
}
...
function Ee(e, t, n) {
    ...
    let i = r.get(n);
    i || r.set(n, (i = new Set())),
        i.has(Ae) || (i.add(Ae), Ae.deps.push(i), Ae.options.onTrack && Ae.options.onTrack({ effect: Ae, target: e, type: t, key: n }));
}
function Ue(e, t, n, r, i, o) {
    ...
    const f = (l) => {
        l.options.onTrigger && l.options.onTrigger({ effect: l, target: e, key: n, type: t, newValue: r, oldValue: i, oldTarget: o }),
...
function $o(e = !1, t = !1) {
    return function (r, i, o) {
        ...
        return (wr(i) ? Bo.has(i) : ou(i)) || (e || Ee(r, 'get', i), t) ? s : er(s) ? (!a || !Or(i) ? s.value : s) : _n(s) ? (e ? Wo(s) : Cr(s)) : s;
    };
}
var uu = lu();
function lu(e = !1) {
...
function jo(e, t) {
    const n = e ? bu : _u;
    return (r, i, o) =>
        i === '__v_isReactive' ? !e : i === '__v_isReadonly' ? e : i === '__v_raw' ? r : Reflect.get(vn(n, i) && i in r ? n : r, i, o);
}
var yu = { get: jo(!1) },
    mu = { get: jo(!0) };
function Ho(e, t, n) {
...
function Vo(e, t, n) {
    we(t, (r) => ve(`You can't use [$${t}] without first installing the "${e}" plugin here: https://alpinejs.dev/plugins/${n}`, r));
}
    ...
    return ee(() => {
        ...
        if (e.type === 'checkbox')
            if (Array.isArray(r)) {
                let i = null;
                return (
                    t.includes('number') ? (i = Nn(n.target.value)) : t.includes('boolean') ? (i = nn(n.target.value)) : (i = n.target.value),
...
Q('show', (e, { modifiers: t, expression: n }, { effect: r }) => {
    ...
    let o = () => {
        ...
        c = Xn(
            (v) => (v ? a() : o()),
            (v) => {
                typeof e._x_toggleAndCascadeWithTransitions == 'function' ? e._x_toggleAndCascadeWithTransitions(e, v, a, o) : v ? s() : o();
            },
        ),
        f,
        l = !0;
...
yn('Mask', 'mask', 'mask');
function yn(e, t, n) {
    Q(t, (r) => ve(`You can't use [x-${t}] without first installing the "${e}" plugin here: https://alpinejs.dev/plugins/${n}`, r));
}
Wt.setEvaluator(eo);
        ...
        .map((r) => {
            ...
            for (; o.length > 0; ) {
                ...
                (a += o.substring(0, s.index)),
                    ...
                    s[0][0] === '\\' && s[1] ? (a += '\\' + String(Number(s[1]) + i)) : ((a += s[0]), s[0] === '(' && n++);
            }
            return a;
        })
        .map((r) => `(${r})`)
...
const el = /\b\B/,
    ...
    dl = { scope: 'regexp', begin: /\/(?=[^/\n]*\/)/, end: /\/[gimuy]*/, contains: [kt, { begin: /\[/, end: /\]/, relevance: 0, contains: [kt] }] },
...
function Ml(e) {
    if (Array.isArray(e.begin)) {
        if (e.skip || e.excludeBegin || e.returnBegin) throw (rt('skip, excludeBegin, returnBegin not compatible with beginScope: {}'), ln);
...
function Cl(e) {
    if (Array.isArray(e.end)) {
        if (e.skip || e.excludeEnd || e.returnEnd) throw (rt('skip, excludeEnd, returnEnd not compatible with endScope: {}'), ln);
...
function Dl(e) {
    ...
    class n {
        ...
        addRule(s, c) {
            (c.position = this.position++), (this.matchIndexes[this.matchAt] = c), this.regexes.push([c, s]), (this.matchAt += Qo(s) + 1);
        }
        compile() {
...
function Nl(e) {
    return (
        ...
        e.cachedVariants ? e.cachedVariants : aa(e) ? je(e, { starts: e.starts ? je(e.starts) : null }) : Object.isFrozen(e) ? je(e) : e
    );
}
var Ll = '11.9.0';
...
https://github.com/highlightjs/highlight.js/issues/2277`,
        ...
        function v(p, y, C, N) {
            ...
            function re() {
                ...
                for (; x; ) {
                    ...
                    if (ne) {
                        const [me, En] = ne;
                        if ((V.addText(D), (D = ''), (W[j] = (W[j] || 0) + 1), W[j] <= kl && (he += En), me.startsWith('_'))) D += x[0];
                        else {
            ...
            function Ve(g, x) {
                ...
                if (ke > 1e5 && ke > x.index * 3) throw new Error('potential infinite loop, way more iterations than matches');
                return ($ += D), D.length;
            }
            const ie = P(p);
            ...
            try {
                ...
                if (g.message && g.message.includes('Illegal'))
                    return {
                        ...
                        illegal: !0,
                        relevance: 0,
                        _illegalBy: { message: g.message, index: le, context: y.slice(le - 100, le + 100), mode: g.mode, resultSoFar: Pe },
                        _emitter: V,
                    };
                if (i) return { language: p, value: Ln(y), illegal: !1, relevance: 0, errorRaised: g, _emitter: V, _top: T };
                throw g;
            }
        }
        function b(p) {
        ...
        function te(p) {
            return lt('10.7.0', 'highlightBlock will be removed entirely in v12.0'), lt('10.7.0', 'Please use highlightElement now.'), S(p);
        }
        Object.assign(e, {
            highlight: l,
            highlightAuto: _,
...
function $l(e) {
    const t = e.regex,
        ...
        a = { scope: 'meta', variants: [{ begin: /<\?php/, relevance: 10 }, { begin: /<\?=/ }, { begin: /<\?/, relevance: 0.1 }, { begin: /\?>/ }] },
        ...
        I = {
            variants: [
                { match: [/new/, t.concat(b, '+'), t.concat('(?!', u(E).join('\\b|'), '\\b)'), i], scope: { 1: 'keyword', 4: 'title.class' } },
            ],
        },
        m = t.concat(r, '\\b(?!\\()'),
        L = {
            variants: [
                ...
                { match: [i, t.concat(/::/, t.lookahead(/(?!class\b)/)), m], scope: { 1: 'title.class', 3: 'variable.constant' } },
    ...
    const q = [K, L, e.C_BLOCK_COMMENT_MODE, _, A, I],
        z = {
            ...
            contains: [
                { begin: /\[/, end: /]/, keywords: { literal: S, keyword: ['new', 'array'] }, contains: ['self', ...q] },
                ...q,
                { scope: 'meta', match: i },
            ],
        };
