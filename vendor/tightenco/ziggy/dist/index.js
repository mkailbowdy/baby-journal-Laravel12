...
var e = String.prototype.replace,
    ...
    f = {
        ...
        compact: function (t) {
            for (var e = [{ obj: { o: t }, prop: 'o' }], r = [], n = 0; n < e.length; ++n)
                for (
                    var o = e[n], i = o.obj[o.prop], a = Object.keys(i), s = 0;
                    s < a.length;
                    ++s
                ) {
                    var f = a[s],
            ...
            return (
                ...
                u(e) && u(r)
                    ? (r.forEach(function (r, o) {
                          if (i.call(e, o)) {
                              var u = e[o];
                              u && 'object' == typeof u && r && 'object' == typeof r
                                  ? (e[o] = t(u, r, n))
                                  : e.push(r);
                          } else e[o] = r;
                      }),
    ...
    m = function t(e, r, n, o, i, u, a, s, c, l, y, g, b, m) {
        var j,
            w = e;
        if (
            ('function' == typeof a
            ...
            if (o) return u && !b ? u(r, v.encoder, m, 'key', y) : r;
            w = '';
        }
        if (
            'string' == typeof (j = w) ||
            ...
            if (u) {
                var $ = b ? r : u(r, v.encoder, m, 'key', y);
                if ('comma' === n && b) {
                    for (var O = h.call(String(w), ','), E = '', R = 0; R < O.length; ++R)
                        E += (0 === R ? '' : ',') + g(u(O[R], v.encoder, m, 'value', y));
                    return [g($) + '=' + E];
                }
                return [g($) + '=' + g(u(w, v.encoder, m, 'value', y))];
            }
        ...
        if ('comma' === n && p(w)) S = [{ value: w.length > 0 ? w.join(',') || null : void 0 }];
        else if (p(a)) S = a;
        else {
            var N = Object.keys(w);
            S = s ? N.sort(s) : N;
            ...
            if (!i || null !== C) {
                var _ = p(w)
                    ? 'function' == typeof n
                        ...
                        : r
                    : r + (c ? '.' + k : '[' + k + ']');
                d(x, t(C, _, n, o, i, u, a, s, c, l, y, g, b, m));
            }
        }
        return x;
    },
        ...
        if (t) {
            ...
            for (var f = 0; r.depth > 0 && null !== (u = i.exec(o)) && f < r.depth; ) {
                if (
                    ((f += 1),
                    !r.plainObjects &&
                        j.call(Object.prototype, u[1].slice(1, -1)) &&
                        !r.allowPrototypes)
                )
                    return;
                s.push(u[1]);
    ...
    S = function (t, e) {
        var r = (function (t) {
            ...
            return {
                ...
                allowPrototypes:
                    'boolean' == typeof t.allowPrototypes ? t.allowPrototypes : $.allowPrototypes,
                arrayLimit: 'number' == typeof t.arrayLimit ? t.arrayLimit : $.arrayLimit,
                charset: void 0 === t.charset ? $.charset : t.charset,
                charsetSentinel:
                    'boolean' == typeof t.charsetSentinel ? t.charsetSentinel : $.charsetSentinel,
                ...
                interpretNumericEntities:
                    'boolean' == typeof t.interpretNumericEntities
                        ...
                        : $.interpretNumericEntities,
                parameterLimit:
                    'number' == typeof t.parameterLimit ? t.parameterLimit : $.parameterLimit,
                              ...
                              for (r = 0; r < o.length; ++r)
                                  if (r !== i) {
                                      var a,
                                          ...
                                          p = -1 === l ? c.indexOf('=') : l + 1;
                                      -1 === p
                                          ? ((a = e.decoder(c, $.decoder, u, 'key')),
                                            (s = e.strictNullHandling ? null : ''))
...
class x {
    ...
    matchesUrl(t) {
        ...
        const r = this.template
                ...
                .replace(/^\w+:\/\//, ''),
            [n, o] = t.replace(/^\w+:\/\//, '').split('?'),
            i =
                null != (e = new RegExp(`^${r}/?$`).exec(n))
                    ? e
                    : new RegExp(`^${r}/?$`).exec(decodeURI(n));
        if (i) {
            for (const t in i.groups)
                i.groups[t] =
                    'string' == typeof i.groups[t] ? decodeURIComponent(i.groups[t]) : i.groups[t];
            return { params: i.groups, query: S(o) };
        }
        return !1;
    }
    compile(t) {
            ...
            ? this.template
                  .replace(/{([^}?]+)(\??)}/g, (e, r, n) => {
                      ...
                      if (!n && [null, void 0].includes(t[r]))
                          throw new Error(
                              `Ziggy error: '${r}' parameter is required for route '${this.name}'.`,
                          );
                      if (
                          this.wheres[r] &&
                          !new RegExp(`^${n ? `(${this.wheres[r]})?` : this.wheres[r]}$`).test(
                              null != (i = t[r]) ? i : '',
                          )
                      )
                          throw new Error(
...
class N extends String {
                            ...
                            ('function' == typeof t.filter || p(t.filter)) && (i = t.filter),
                            {
                                ...
                                serializeDate:
                                    'function' == typeof t.serializeDate
                                        ...
                                        : v.serializeDate,
                                skipNulls:
                                    'boolean' == typeof t.skipNulls ? t.skipNulls : v.skipNulls,
    ...
    p(e) {
        ...
        let r = {};
        const [n, o] = Object.entries(this.t.routes).find(
            ([t, n]) => (r = new x(t, n, this.t).matchesUrl(e)),
        ) || [void 0, void 0];
    ...
    v() {
        ...
        return (
            (this.t.absolute
                ? t + e
                : e.replace(this.t.url.replace(/^\w*:\/\/[^/]+/, ''), '').replace(/^\/+/, '/')) + r
        );
    }
    current(e, r) {
        ...
        r = this.l(r, s);
        const f = t({}, o, i);
        if (Object.values(r).every((t) => !t) && !Object.values(f).some((t) => void 0 !== t))
            return !0;
        const c = (t, e) =>
                ...
                ? (e = e.reduce(
                      (e, r, o) =>
                          t(
                              {},
                              e,
                              n[o] ? { [n[o].name]: r } : 'object' == typeof r ? r : { [r]: '' },
                          ),
                      {},
                  ))
                : 1 !== n.length ||
