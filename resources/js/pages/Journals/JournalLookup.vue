...
const findActiveJournal = (journalToFind: Journal): void => {
    activeJournal.value = localJournals.value.find((journal: Journal) => journal.id === journalToFind.id) || null;
    ...
    <AuthenticatedLayout>
                    ...
                    >
                        ...
                        <g id="SVGRepo_iconCarrier">
                            ...
                            <g id="🔍-Product-Icons" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                <g id="ic_fluent_timeline_24_regular" class="fill-emerald-500" fill-rule="nonzero">
                                    <path
        ...
        <div class="mx-auto max-w-2xl p-4 sm:p-6 lg:p-8">
            <div v-if="!open" class="flex flex-row items-center gap-4">
                <JournalSearch :journals="localJournals" @activeJournal="findActiveJournal" />
            </div>
            <div v-else>
                <JournalForm
            ...
            <div v-if="activeJournal" class="mt-6 divide-y rounded-lg bg-white shadow-md">
                <JournalDetails
